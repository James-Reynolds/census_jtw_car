...
Population of driving age was extracted from the census results that are enumerated by place of usual residence. The following loads and cleans the data for 2011, 2016 and 2021. The data includes all Greater Capital City Statistical Areas (GCCSAs) and all Local Government Areas (LGAs)


```{r population_load_data, message=FALSE, warning=FALSE}
...
```{r population_of_driving_age_summarise_data, message=FALSE, warning=FALSE}
